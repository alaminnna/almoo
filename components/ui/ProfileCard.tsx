...
const DEFAULT_INNER_GRADIENT =
  "linear-gradient(145deg, oklch(68% 0.120 40 / 0.55) 0%, oklch(65% 0.140 25 / 0.35) 100%)";
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
    ...
    const setVarsFromXY = (x: number, y: number): void => {
      ...
      const batch = [
        ...
        "--pointer-from-center", `${clamp(
          Math.hypot(percentY - 50, percentX - 50) / 50, 0, 1
        )}`,
      ...
      for (let i = 0; i < batch.length; i += 2)
        wrap.style.setProperty(batch[i], batch[i + 1]);
    };
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      "--behind-glow-color": behindGlowColor ?? "rgba(200, 120, 60, 0.55)",
      ...
      "--sunpillar-1": "hsl(14, 80%, 65%)",
      "--sunpillar-2": "hsl(28, 85%, 60%)",
      "--sunpillar-3": "hsl(40, 90%, 65%)",
      "--sunpillar-4": "hsl(20, 70%, 55%)",
      "--sunpillar-5": "hsl(350, 60%, 50%)",
      "--sunpillar-6": "hsl(10, 75%, 55%)",
    ...
    () => ({
      ...
      backgroundImage: `
        ...
        radial-gradient(
          ...
          hsla(25, 50%, 0%, 0.1) 12%,
          hsla(25, 50%, 0%, 0.15) 20%,
          hsla(25, 50%, 0%, 0.25) 120%
        )
      `.replace(/\s+/g, " "),
      gridArea: "1 / -1",
  ...
  const glareStyle = useMemo<React.CSSProperties>(
    () => ({
      ...
      backgroundImage: `radial-gradient(
        farthest-corner circle at var(--pointer-x) var(--pointer-y),
        hsl(25, 60%, 75%) 12%,
        hsla(14, 50%, 30%, 0.8) 90%
      )`,
      mixBlendMode: "overlay",
      filter: "brightness(0.8) contrast(1.2) opacity(0.6)",
      zIndex: 4,
      gridArea: "1 / -1",
      borderRadius: cardRadius,
      pointerEvents: "none",
              ...
              >
                <h3
                  ...
                  style={{
                    ...
                    backgroundImage:
                      "linear-gradient(to bottom, #fff, var(--color-paper-3))",
                ...
                <p
                  ...
                  style={{
                    ...
                    margin: "0 auto",
                    backgroundImage:
                      "linear-gradient(to bottom, #fff, var(--color-accent))",
                    backgroundSize: "1em 1.5em",
                    WebkitTextFillColor: "transparent",
                    backgroundClip: "text",
                    WebkitBackgroundClip: "text",
